...
> This section describes a change on this branch, not upstream.
...
These rules are written up in full, with the evidence behind each, at
[schwab-cgt-reference](https://github.com/uk-cgt-tools/schwab-cgt-reference).
Two other tools implement the same description independently.
